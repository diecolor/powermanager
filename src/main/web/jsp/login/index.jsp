		...
		<div class='login'>
			...
			<div class='login_fields'>
				<div class='login_fields__user'>
					...
					<input name="username" value="15951614133" id="username" placeholder='请输入手机号码' maxlength="16" type='text' autocomplete="off"  />
				...
				<div class='login_fields__password'>
					...
					<input name="password" id="password" value="000000" placeholder='请输入密码' maxlength="16" type='password' autocomplete="off">
					<div class='validation' style="cursor: pointer">
						<img alt="" src='<%=basePath%>static/login/img/tick.png' style="cursor: pointer">
					</div>
				</div>
				<div class='login_fields__password'>
					<div class='icon'>
